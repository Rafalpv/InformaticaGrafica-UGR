...
protected:
       _cilindro rueda_excavadora;
       _cubo base_excavadora;
};
...
protected:
       _pala pala_excavadora;
       _brazo brazo_excavadora;
       _cabina cabina_excavadora;
       _sustentacion sustentacion_excavadora;
};
